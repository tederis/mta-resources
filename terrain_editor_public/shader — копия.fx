...
float4 PixelShaderFunction(PSInput PS) : COLOR0
{
    ...
    float4 texel1 = tex2D(Sampler1, PS.TexCoord * 9);
    float4 texel2 = tex2D(Sampler2, PS.TexCoord * 9);
    float4 texel3 = tex2D(Sampler3, PS.TexCoord * 9);
    float4 texel4 = tex2D(Sampler4, PS.TexCoord * 9);
    float4 texel5 = tex2D(Sampler5, PS.TexCoord * 9);
    float4 texel6 = tex2D(Sampler6, PS.TexCoord * 9);
    float4 texel7 = tex2D(Sampler7, PS.TexCoord * 9);
    float4 texel8 = tex2D(Sampler8, PS.TexCoord * 9);
