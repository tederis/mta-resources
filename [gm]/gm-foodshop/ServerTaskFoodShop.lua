...
function ServerTaskFoodShop.start ( ped, object, taskOrder )
	local taskAnim
	...
	ServerTaskFoodShop.collection [ ped ] = weaponShopTask
	
	setPedAnimation ( ped, "WEAPONS", taskAnim, -1, false, false )
end

function ServerTaskFoodShop.update ( self )
...
function ServerTaskFoodShop.isEnded ( self )
